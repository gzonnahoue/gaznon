		 ...
		 <div id="bottom-footer" class="clearfix">
			<div class="tg-container">
				<div class="copy-right">
					<?php printf( esc_html__( 'Copyright 2018 ©', '' ), 'eStore', '<a href="'.esc_url ( 'https://themegrill.com' ).'" rel=""></a>' ); ?>
					<span class="sep"> | </span>
					<?php printf( esc_html__( 'Proudly powered by %s.', 'estore' ), '<a href="'.esc_url ( 'https://pivotech.xyz/' ).'">PIVOTECH_one</a>' ); ?>
				</div>
				<?php
				$logos = array();
				for ( $i = 1; $i < 5; $i++ ) {
